#Ryan Barber assignment 10 3/8/26
...
class Todo(tk.Tk):
    ...
    def __init__(self, tasks=None):
        ...
        self.title("Barber-ToDo")
        self.geometry("300x400")

        # Menu bar with Exit (MODIFIED)
